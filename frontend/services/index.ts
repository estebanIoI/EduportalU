// auth
export { authService } from './evaluacionITP/auth/auth.service';
export { rolesService } from './evaluacionITP/auth/roles.service';
export { userRolesService } from './evaluacionITP/auth/userRoles.service';
...
export { escalasValoracionService } from './evaluacionITP/evaluacion/escalasValoracion.service';
...
export { profesoresService } from './evaluacionITP/reportes/profesores.service';

// sigedin
export { vistaAcademicaService } from './evaluacionITP/sigedin/vistaAcademicaInsitu.service';
