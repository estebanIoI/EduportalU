    ...
    <CardHeader className="text-center">
      ...
      <CardTitle
        className={`flex items-center justify-center gap-2 ${
          videoFormat === "short" ? "text-2xl sm:text-3xl" : "text-2xl sm:text-3xl"
        } font-bold text-gray-800 transform hover:scale-105 transition-transform duration-200 mt-4`}
      >
        Iniciar Sesión
      </CardTitle>
      <CardDescription
        className={`${
          videoFormat === "short" ? "text-base sm:text-lg" : "text-base sm:text-lg"
        } text-gray-600 mt-2 px-2`}
      >
